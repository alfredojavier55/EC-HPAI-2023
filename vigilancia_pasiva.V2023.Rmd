...
vge1 <- read_excel("C:/Users/Joha/Desktop/AVES2022/VEO2_GAVES2022.xlsx", 
    skip = 2)
vge2 <- read_excel("C:/Users/Joha/Desktop/AVES2023/VEO2_GAVES2023.xlsx", 
    skip = 2)

vr1 <- readxl::read_excel("C:/Users/Joha/Desktop/AVES2022/VEO2_RAVES2022.xlsx", skip = 1)
vr2 <- readxl::read_excel("C:/Users/Joha/Desktop/AVES2023/VEO2_RAVES2023.xlsx", skip = 1)

vc1 <- readxl::read_excel("C:/Users/Joha/Desktop/AVES2022/VEO2_CAVES2022.xlsx", skip = 1)
vc2 <- readxl::read_excel("C:/Users/Joha/Desktop/AVES2023/VEO2_CAVES2023.xlsx", skip = 1)
...
# -- Vigilancia general ----
v0 <- full_join(vge1, vge2)
v4 <- full_join (vr1, vr2)
v5 <- full_join(v0,v4)
v6 <- full_join(vc1, vc2)
v1 <- full_join(v5,v6)
...
sum(v2$pos)/sum(v2$total_muestras)
...
##HASTA AQUI## Número de notificaciones por especie notificacion intermedia
```{r}
 v2 %>%
   # group_by(month)%>%
